...
export Stage1_CMD=" \
    main.py \
    --cfg configs/bi_ttt/bi_vttt_small_224_DISFA_12for3.yaml \
    --model_ema False \
    --tag disfa_12for3_h6_m14_2waycat_passconv_219_ft_mixup_bp4d_tttema \
    --pretrained checkpoint/bp4d13for2/ckpt_epoch_13.pth \
    --use_wandb
    "
